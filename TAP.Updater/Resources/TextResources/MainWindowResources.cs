...
namespace TAP.UPDATER.Resources.TextResources {
    ...
    public static class MainWindowResources {
        ...
        /// </summary>
        public static readonly string MAIN_WINDOW_TITLE = "TAP-Updater {0}";
        ...
        /// </summary>
        public static readonly string ALREADY_RUNNING = "Another instance of the TAP-Updater is already running.";

        /// <summary>
        /// The title of the window triggered whenever there is already another instance of the Auto-Updater running.
        /// </summary>
        public static readonly string ALREADY_RUNNING_ERROR = "Error Starting TAP-Updater";
    }
}
