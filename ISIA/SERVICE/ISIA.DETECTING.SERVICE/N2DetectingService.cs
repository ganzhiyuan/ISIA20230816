    ...
    class N2DetectingService : TAP.WinService.ServiceBase
    {
        ...
        private DataTable GetmailData()
        {
            ...
            try
            {
                ...
                selectSQL.Append("WHERE MAILUSED = 'YES' AND RULENAME <> 'AverageRules'  ");
        ...
        private void SendMail()
        {
            ...
            if (mailData is null)
            {
                Console.WriteLine("Don't send mail - No data.");
                return;
            }
        ...
        //            sbMailList.AppendFormat("		<td class=\"td\" align=\"center\"><strong>{0}</strong></td>", (Convert.ToDecimal(drTemp["TARGET"])).ToString("%"));
