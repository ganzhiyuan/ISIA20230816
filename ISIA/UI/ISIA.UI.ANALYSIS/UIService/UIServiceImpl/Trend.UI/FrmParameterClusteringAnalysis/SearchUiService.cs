...
{
    public class SearchUiService : CommonUIService<FrmOrclParmsTrendChart, object, AwrArgsPack>
    {

        public SearchUiService(FrmOrclParmsTrendChart frm, object args, AwrArgsPack argsPack) : base(frm, args, argsPack)
        {
