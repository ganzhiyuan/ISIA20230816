...
{
    public partial class FrmParameterTClusteringAnalysis : DockUIBase1T1
    {
        ...
        public FrmParameterTClusteringAnalysis()
        {
            InitializeComponent();
            bs = new BizDataClient("ISIA.BIZ.ANALYSIS.DLL", "ISIA.BIZ.ANALYSIS.ParameterTClusteringAnalysis");
