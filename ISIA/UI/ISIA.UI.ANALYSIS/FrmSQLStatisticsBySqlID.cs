...
{
    public partial class FrmSQLStatisticsBySqlID : DockUIBase1T1
    {
        ...
        DateTime etime ;
        #endregion
        public FrmSQLStatisticsBySqlID()
        {
            InitializeComponent();
            bs = new BizDataClient("ISIA.BIZ.ANALYSIS.DLL", "ISIA.BIZ.ANALYSIS.SQLStatisticsBySqlID");
