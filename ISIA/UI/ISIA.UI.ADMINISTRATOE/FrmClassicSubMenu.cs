...
{
    public partial class FrmClassicSubMenu : DockUIBase1T1
    {
        public FrmClassicSubMenu()
        {
            InitializeComponent();
            InitializeComTextBox();
            bs = new BizDataClient("ISIA.BIZ.ADMINISTRATOE.DLL", "ISIA.BIZ.ADMINISTRATOE.SubMenu");
        }
        ...
        {
            args.MAINMENU = cboMainmenu1.Text;

            try
            {
                ds = bs.ExecuteDataSet("GetSubMenu", args.getPack());
        ...
        public void GridViewStyle()
        {
            ...
            gridView1.Columns["SHORTCUTKEY"].Visible = false;
            gridView1.Columns["SHORTCUTCHARACTER"].Visible = false;
            gridView1.Columns["SHORTCUTDISPLAYSTRING"].Visible = false;
            gridView1.Columns["SHORTCUTKEYS"].Visible = false;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtMDI.Text))
            {
                ...
                return;
            } if (string.IsNullOrEmpty(cboMainMenu.Text))
            {
                TAPMsgBox.Instance.ShowMessage(this.Text, EnumMsgType.WARNING, "You must input MainMenu.");
                return;
            }
            ...
            if (dialog.ToString() == "Yes")
            {
                try
                {
                    ...
                    SaveCount = bs.ExecuteModify("SaveSubMenu", args.getPack());
            ...
            if (dialog.ToString() == "Yes")
            {
                ...
                try
                {
                    for (int i = 0; i < focusedRowHandles.Distinct().ToList().Count; i++)                    
                    {
                        ...
                        args.ICON = tmpRow["IMAGE"].ToString();
                        ...
                        bs.ExecuteModify("UpdateSubMenu", args.getPack());
            ...
            if (dialog.ToString() == "Yes")
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < selectRowNum.Count; i++)
                    {
                        ...
                        DeleteCount = bs.ExecuteModify("DeleteSubMenu", args.getPack());
                    }
                    if (DeleteCount > 0)
                    {
