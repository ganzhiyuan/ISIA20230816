    ...
    public class SQLStatisticsBySqlID : TAP.Remoting.Server.Biz.BizComponentBase
    {
        ...
        public void GetSnap(AwrCommonArgsPack arguments)
        {
            ...
            try
            {
                ...
                tmpSql.AppendFormat(" SELECT b.end_interval_time, a.command_type,T.{0},T.sql_id ,t.action,t.module,t.INSTANCE_NUMBER,t.PARSING_SCHEMA_NAME", arguments.ParameterName);
                ...
                tmpSql.AppendFormat(" where 1=1 and b.begin_interval_time>to_date('{0}','yyyy-MM-dd HH24:mi:ss')", arguments.StartTimeKey);
