        ...
        public void GetWorkloadDataByParams(AwrArgsPack arguments)
        {
            ...
            try
            {
                ...
                tmpSql.AppendFormat("" +
                    ...
                    "FROM ISIA.RAW_DBA_HIST_SYSMETRIC_SUMMARY_ISFA sm, -- DBA_HIST_METRIC_NAME mn,\r\n" +
                    "ISIA.RAW_DBA_HIST_SNAPSHOT_ISFA sn\r\n" +
                    "WHERE 1 = 1\r\n" +
                    ...
                    "FROM ISIA.RAW_DBA_HIST_SYSSTAT_ISFA ss, -- DBA_HIST_STAT_NAME nm,\r\n" +
                    "ISIA.RAW_DBA_HIST_SNAPSHOT_ISFA sn\r\n" +
                    "WHERE 1 = 1\r\n" +
                    ...
                    "ORDER BY dbid, workdate\r\n"
                     , arguments.GroupingDateFormat, arguments.StartTime, arguments.EndTime
                    );
                RemotingLog.Instance.WriteServerLog(MethodInfo.GetCurrentMethod().Name, LogBase._LOGTYPE_TRACE_INFO, this.Requester.IP,
                       tmpSql.ToString(), false);
