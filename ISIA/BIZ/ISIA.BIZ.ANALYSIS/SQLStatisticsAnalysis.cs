...
{
    public class SQLStatisticsAnalysis : TAP.Remoting.Server.Biz.BizComponentBase
    {
        ...
        public void GetSnap(AwrCommonArgsPack arguments)
        {
            ...
            try
            {
                ...
                tmpSql.AppendFormat(@" SELECT t.snap_id,t.end_time as END_INTERVAL_TIME ,T.DBID,
                ...
                tmpSql.AppendFormat("  WHERE T.dbid IN ('{0}')", arguments.DbId);

                tmpSql.AppendFormat(" and T.BEGIN_TIME >= TO_DATE('{0}', 'yyyy-MM-dd HH24:mi:ss')", arguments.StartTimeKey);
                ...
                tmpSql.Append(" group by t.snap_id ,t.end_time,T.DBID order by t.end_time ");
        ...
        public void GetDeltaAndSnap(AwrCommonArgsPack arguments)
        {
            ...
            { 
                ...
                tmpSql.Append(@" SELECT t.snap_id,t.end_time as END_INTERVAL_TIME ,T.DBID,
